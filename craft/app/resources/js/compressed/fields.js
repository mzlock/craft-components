...
{id:this.$selectedGroup.data("id")};Craft.postActionRequest("fields/deleteGroup",a,b.proxy(function(a,b){"success"==b&&(a.success?location.href=Craft.getUrl("settings/fields"):Craft.cp.displayError())},this))}},flattenErrors:function(a){var b=[],d;for(d in a)b=b.concat(a[d]);return b}});Garnish.$doc.ready(function(){Craft.FieldsAdmin=new e})})(jQuery);
