...
this.$body.html('<p class="centeralign">'+b+' <a class="go nowrap" href="'+Craft.getUrl("updates")+'">'+Craft.t("Go to Updates")+"</a></p>")}else this.$body.html('<p class="centeralign">'+Craft.t("Congrats! You\u2019re up-to-date.")+'</p><p class="centeralign"><a class="btn" data-icon="refresh">'+Craft.t("Check again")+"</a></p>"),this.initBtn();Craft.cp.displayUpdateInfo(a)}})})(jQuery);
